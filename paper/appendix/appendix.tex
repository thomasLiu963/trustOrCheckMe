...
\section{Protocol provenance and preregistration}
\label{app:protocol}
...
The preregistered hypotheses were: (H1) verification should generally increase
as error cost rises; (H2) changing decision authority may change verification
policy, with no universal direction preregistered; (H3) showing frozen
...
The preregistered prompt-robustness run covered the hidden-confidence condition
...
the hidden robustness analysis preregistered and the visible half a
...
\texttt{20260904}. The 500-question primary sample contains the original
200-question sample plus 300 category-stratified additions selected without
reference to observed results. The fixed 100-question robustness subset was
selected category-stratified from the 500-question sample, also without
reference to outcomes. The primary-sample SHA-256 recorded in the manifest is\\
...
subset. The hidden-confidence paraphrase was preregistered; visible-confidence
...
prices. Of this, the V2-B core run accounts for 21,600 attempts, 12.84 million
tokens, and 9.2 hours; the earlier V2-A validation run on the overlapping
200-question subset accounts for 13,532 attempts, 8.15 million tokens, and
5.7 hours; and the 6,400 paraphrase cells account for 6,400 attempts,
3.93 million tokens, and 2.9 hours. A one-question smoke test is included
and is negligible (68 attempts).
